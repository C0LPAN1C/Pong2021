...
Player.cs contains information about Player and attributes
...
public class Player : MonoBehaviour {
	...
	const float kmove = 8.0f;
	const float kup = 8.5f;
	const float kball = 4.0f;
	const float kballspeed = 12.0f;
